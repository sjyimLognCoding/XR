...
//     private void Update()
//     {
//         if (Input.GetKeyDown(KeyCode.Space) && paper)
//         {
//             DestroyMesh(paper);
//         }
//     }
...
//         entry.transform.position = other.contacts[0].point + new Vector3(0, GetComponent<Collider>().bounds.extents.y,
...
//                 // ));
//                 Plane plane = new Plane(entry.transform.position, exit.transform.position, transform.up);
...
//     public void MakeGameObject(CutEvent original)
//     {
